...
<div class="container">
    ...
    <div class="front-page-text"><br>
        ...
        <h4>It knows every game so there is unlimited fun, posibility and never done playing tournaments.</h4>
        <h4>if it doesn't you can simply add it in the settings.</h4>
    </div>
